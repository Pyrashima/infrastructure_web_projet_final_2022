      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="nouvelles_categorie_general.php">Général</a></li>
            <li><a class="dropdown-item" href="nouvelles_categorie_consignes.php">Consignes</a></li>
            <li><a class="dropdown-item" "active" href="nouvelles_categorie_lorem.php">Lorem ipsum</a></li>
...
<div class="modal" id="modalConnexion" tabindex="-1" role="dialog">
  ...
  <!-- Page Content -->
	...
	<h1 class="my-5"><?php echo 'Lorem Ipsum'; ?></h1>
    ...
    while ($row = $res->fetch_assoc()) {
      echo $row["id"] . ',' . $row ["titre"] . ',' . $row["date_nouvelle"] . ',' . $row["actif"] . '<br>';
    }
  </div>
